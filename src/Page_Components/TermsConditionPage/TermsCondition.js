...
const TermsAndConditionPageBody = () => {
  return (
    <>
      <PGLINK
        to="/"
      ...
      <section className="TC-container">
        ...
        <p>
          <b> Last updated January 10, 2024</b>
        </p>
        <section id="legalTerms">
          <h2>AGREEMENT TO OUR LEGAL TERMS</h2>
          <p>
            We are Valsco Technology Private Limited ('Company', 'we', 'us', or
            'our'), a company registered in India at J-3 sector 49, Shatabdi
            Enclave, Noida, UTTAR PRADESH 201301.
          </p>
          <p>
            We operate the website http://www.valscotech.com (the 'Site'), as
          ...
          <p>
            You can contact us by email at connect@valscotech.com or by mail to
            J-3 sector 49, Shatabdi Enclave, Noida, UTTAR PRADESH 201301, India.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ('you'),
            and Valsco Technology Private Limited, concerning your access to and
          ...
          <p>
            ...
            effective upon posting or notifying you by sanidhya1974@gmail.com,
        ...
        <section id="tableOfContent">
          ...
          <ol type="1">
            ...
            <li>
              <Link to="propertyRights"> INTELLECTUAL PROPERTY RIGHTS</Link>
            </li>
            <li>
              <Link to="presentations"> USER REPRESENTATIONS</Link>
            </li>
            <li>
              <Link to="pay&Purchase"> PURCHASES AND PAYMENT</Link>
            </li>
            <li>
              <Link to="policy"> POLICY</Link>
            </li>
            <li>
              <Link to="activitiesProhibited"> PROHIBITED ACTIVITIES</Link>
            </li>
            <li>
              <Link to="contributions"> USER GENERATED CONTRIBUTIONS</Link>
            </li>
            <li>
              <Link to="contriLicence"> CONTRIBUTION LICENSE</Link>
            </li>
            <li>
              <Link to="serviceMngment"> SERVICES MANAGEMENT</Link>
            </li>
            <li>
              <Link to="privacyPolicy"> PRIVACY POLICY</Link>
            </li>
            <li>
              <Link to="infringements"> COPYRIGHT INFRINGEMENTS</Link>
            </li>
            <li>
              <Link to="terms"> TERM AND TERMINATION</Link>
            </li>
            <li>
              <Link to="intruptions"> MODIFICATIONS AND INTERRUPTIONS</Link>
            </li>
            <li>
              <Link to="law"> GOVERNING LAW</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="limitations"> LIMITATIONS OF LIABILITY</Link>
            </li>
            <li>
              <Link to="idemnification"> INDEMNIFICATION</Link>
            </li>
            <li>
              <Link to="userData"> USER DATA</Link>
            </li>
            <li>
              <Link to="eCommunications">
                {" "}
            ...
            <li>
              <Link to="participationClause">
                {" "}
                ENROLLMENT AND PARTICIPATION CLAUSE
              </Link>
            </li>
            <li>
        ...
        <section id="propertyRights">
          ...
          <p>
            ...
            us Submissions and/or posting Contributions through any part of the
          ...
          <p>
            ...
            refer to the
            <Link to="infringements">'COPYRIGHT INFRINGEMENTS'</Link> section
            below.
          </p>
        </section>
        ...
        <section id="activitiesProhibited">
        ...
        <section id="contriLicence">
          ...
          <ul>
            ...
            <li>Grant and authorize sublicenses of the foregoing.</li>
          </ul>
          ...
          <p>We have no obligation to monitor your Contributions.</p>
        </section>
        <section id="serviceMngment">
        ...
        <section id="privacyPolicy">
          ...
          <p>
            ...
            Policy:{" "}
            <PGLINK to="/PrivacyPage">
              https://www.valscotech.com/PrivacyPage.{" "}
            </PGLINK>
        ...
        <section id="intruptions">
          ...
          <p>
            ...
            the Services without notice at any time. We will not be liable to
        ...
        <section id="law">
          ...
          <p>
            ...
            laws of India. Valsco Technology Private Limited and yourself
        ...
        <section id="disputes">
          ...
          <p>
            ...
            arbitration shall be GREATER NOIDA, India. The language of the
            proceedings shall be English or Hindi. The governing law of these
            Legal Terms shall be substantive law of India.
          </p>
          <h3>Restrictions</h3>
          <p>
        ...
        <section id="participationClause">
          <h2>23. ENROLLMENT AND PARTICIPATION CLAUSE</h2>
          <p>
            By purchasing any courses offered by Valsco Technology Pvt. Ltd.,
            you acknowledge and agree to be added to the respective WhatsApp
            group designated for the course. Participation in the WhatsApp group
            is essential for receiving important updates, announcements, and
            engaging in discussions related to the course content. It is
            imperative to note that Valsco Technology Pvt. Ltd. holds no
            responsibility for individuals who choose not to join the WhatsApp
            group. The group serves as a primary communication channel, and
            failure to participate may result in missed information crucial to
            your course experience. Upon the purchase of any course, please
            allow a grace period of 1-2 days for administrative processes before
            actively commencing with the course content. This time frame is
            allocated for the seamless integration of your enrollment and to
            ensure you have access to all necessary materials. Your commitment
            to active participation in the WhatsApp group enhances your overall
            learning experience and facilitates effective communication between
        ...
        <section id="contactUs">
          ...
          <p>
            ...
            at:
            <p>
              <ul type="none" style={{ margin: "1rem 0" }}>
                <li>
                  <b>Valsco Technology Private Limited</b>
                </li>
                <li>
                  <b>J-3 sector 49, Shatabdi Enclave</b>
                </li>
                <li>
...
export default TermsAndConditionPageBody;
