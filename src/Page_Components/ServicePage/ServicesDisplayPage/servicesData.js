...
export const services = [
  {
    ...
    data: frontend_data,
    content:
      "HTML annd CSS,Javascript,Front-End Web Developement, React(Web Framework), Web Development, User Experience, Algorithms, ",
    imgLink: webdev,
    amount: 3500,
  },
  {
  ...
  },
  {
    ...
    data: android_data,
    content:
      "Mobile Development, Android Development,Computer Peograming, Java programming, Programming Principles, Application Development.....",
    imgLink: appdev,
    amount: 4000,
  },
  {
